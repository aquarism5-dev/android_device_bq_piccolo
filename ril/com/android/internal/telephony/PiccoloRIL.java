...
public class PiccoloRIL extends RIL implements CommandsInterface {
    ...
    public PiccoloRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
    }

    public PiccoloRIL(Context context, int networkMode, int cdmaSubscription, Integer instanceId) {
    ...
    protected RILReceiver createRILReceiver() {
        return new BQRILReceiver();
    }

    protected class BQRILReceiver extends RILReceiver {
        byte[] buffer;

        protected BQRILReceiver() {
...
*/
    ...
    public void getDataCallProfile(int appType, Message result) {
        RILRequest rr = RILRequest.obtain(RIL_REQUEST_GET_DATA_CALL_PROFILE, result);
